...
public class AdminDataTransaksiActivity extends AppCompatActivity {
    ...
    private void getTransactionList() {
        Gson gson = new Gson();
        UserService.requestTransaksi().enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if (response.isSuccessful()){
                    ...
                    try {
                        ...
                        JSONArray jsonArray = jsonRESULTS.getJSONArray("getAllTransaksi");
